package com.moensun.cloud.integration.spring.boot.aliyun.sms;

import com.moensun.cloud.integration.spring.boot.aliyun.sms.annotations.EnableAliYunSMSClients;
