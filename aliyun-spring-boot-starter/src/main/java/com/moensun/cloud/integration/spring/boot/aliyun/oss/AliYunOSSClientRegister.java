package com.moensun.cloud.integration.spring.boot.aliyun.oss;

import com.moensun.cloud.integration.spring.boot.aliyun.oss.annotations.AliYunOSSClient;
import com.moensun.cloud.integration.spring.boot.aliyun.oss.annotations.EnableAliYunOSSClients;
...
public class AliYunOSSClientRegister implements ImportBeanDefinitionRegistrar, ResourceLoaderAware, EnvironmentAware {
    ...
    private void registerAliYunOssClient(BeanDefinitionRegistry registry, AnnotationMetadata annotationMetadata,
        ...
        AliYunOSSClientFactoryBean factoryBean = new AliYunOSSClientFactoryBean();
