package com.moensun.cloud.integration.spring.boot.tencentcloud.sms;

import com.moensun.cloud.integration.spring.boot.tencentcloud.sms.annotations.EnableTencentCloudSMSClients;
import com.moensun.cloud.integration.spring.boot.tencentcloud.sms.annotations.TencentCloudSMSClient;
...
public class TencentCloudSMSClientRegister implements ImportBeanDefinitionRegistrar, ResourceLoaderAware, EnvironmentAware {
    ...
    private void registerSmsClients(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
        ...
        Map<String, Object> attrs = metadata.getAnnotationAttributes(EnableTencentCloudSMSClients.class.getName());
        final Class<?>[] channels = attrs == null ? null : (Class<?>[]) attrs.get("clients");
        if (channels == null || channels.length == 0) {
            ClassPathScanningCandidateComponentProvider scanner = getScanner();
            scanner.setResourceLoader(this.resourceLoader);
            scanner.addIncludeFilter(new AnnotationTypeFilter(TencentCloudSMSClient.class));
        ...
        for (BeanDefinition candidateComponent : candidateComponents) {
            if (candidateComponent instanceof AnnotatedBeanDefinition) {
                ...
                Map<String, Object> attributes = annotationMetadata
                        .getAnnotationAttributes(TencentCloudSMSClient.class.getCanonicalName());
    ...
    private void registerAliYunOssClient(BeanDefinitionRegistry registry, AnnotationMetadata annotationMetadata,
        ...
        TencentCloudSMSClientFactoryBean factoryBean = new TencentCloudSMSClientFactoryBean();
        ...
        BeanDefinitionBuilder definition = BeanDefinitionBuilder.genericBeanDefinition(clazz, () -> {
            ...
            factoryBean.setSdkAppId(getSdkAppId(beanFactory, attributes));
    ...
    protected Set<String> getBasePackages(AnnotationMetadata importingClassMetadata) {
        Map<String, Object> attributes = importingClassMetadata
                .getAnnotationAttributes(EnableTencentCloudSMSClients.class.getCanonicalName());
    ...
    String getSdkAppId(ConfigurableBeanFactory beanFactory, Map<String, Object> attributes) {
        String endpoint = (String) attributes.get("sdkAppId");
        return resolve(beanFactory, endpoint);
    }
